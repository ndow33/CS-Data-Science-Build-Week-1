...
#######################################__FIT__################################################
    ...
    def fit(self, X, y):
        '''
        This method takes in two variables, X and y.
        X should be a data set of features and y should be the target variable.
        By fitting our decision tree to this input data, we are able to make
        predictions given future data.
        Our decision tree will be built by finding the optimal features and thresholds 
        within this data.
        '''
...
#####################################__BEST_SPLIT__##############################################
    ...
    def _best_split(self, X, y):
        '''
        This method finds the optimal feature and threshold at which to split the tree
        '''
